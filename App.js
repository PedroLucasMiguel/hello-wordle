...
const LetterRow = (props) => {
    ...
    if (props.word != undefined) {
        ...
        if (props.word != chosenWord) {
            for(let i = 0; i < WORD_LEN; i++) {
                for(let j = 0; j < WORD_LEN; j++) {

                    if (props.word[i] === chosenWord[j] && i == j){
                        lStyle[i] = styles.gameLetterBoxRight;
                        break;
                    }

                    else if (props.word[i] === chosenWord[j] && i != j)
                        lStyle[i] = styles.gameLetterBoxExists;
        ...
        return(
            <View style={styles.gameLetterRow}>
                <LetterBox letter={props.word[0]} letterBoxStyle={lStyle[0]}/>
                <LetterBox letter={props.word[1]} letterBoxStyle={lStyle[1]}/>
                <LetterBox letter={props.word[2]} letterBoxStyle={lStyle[2]}/>
                <LetterBox letter={props.word[3]} letterBoxStyle={lStyle[3]}/>
                <LetterBox letter={props.word[4]} letterBoxStyle={lStyle[4]}/>
            </View>
        );
...
const App = () => {
    ...
    return(
        <ScrollView style={styles.gameBackground}>
            <Text style={styles.gameTitle}>Hello Wordle!</Text>
                ...
                <Button 
                    ...
                    onPress={() => {
                        ...
                        if (textInputValue.length != 5)
                            Alert.alert('The word need to have at least 5 letters!');
